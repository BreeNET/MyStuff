...
I am hosting a call of duty mw2 server on pc. I set up this discord bot so it posts a random array of maps that users can react emoji to them to vote for the next map they want to play. I had intended on making it automatically update a configuration file on my desktop but I never got around to it. 
